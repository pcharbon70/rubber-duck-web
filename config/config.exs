...
config :rubberduck_web, RubberduckWebWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: RubberduckWebWeb.ErrorHTML, json: RubberduckWebWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: RubberduckWeb.PubSub,
  live_view: [signing_salt: "NfI6qhDw"]
...
config :rubberduck_web, RubberduckWeb.Mailer, adapter: Swoosh.Adapters.Local
